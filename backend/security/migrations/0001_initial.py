...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['event_type', 'severity'], name='security_se_event_t_5077ff_idx'), models.Index(fields=['timestamp'], name='security_se_timesta_684804_idx'), models.Index(fields=['ip_address'], name='security_se_ip_addr_1ea45a_idx')],
            },
        ),
    ]
